...
from .serializers_normalized import (
    ...
    UserLevelSerializer, SectionSerializer, DistrictSerializer, UserProfileSerializer,
    UserAssignmentHistorySerializer, UserPermissionSerializer, MyTokenObtainPairSerializer
)
...
class UserViewSet(viewsets.ModelViewSet):
    """ViewSet for User model with normalized relationships"""
...
class RegisterView(APIView):
    """User registration view with normalized models"""
...
def district_users_list(request):
    ...
    ).select_related('userlevel', 'section', 'district').order_by('district__name', 'section__name', 'userlevel__name', 'last_name')
