...
# Email header branding (logo)
# Use absolute URL for email clients. Configure via environment variables.
EMAIL_HEADER_LOGO_URL = os.getenv("EMAIL_HEADER_LOGO_URL")
EMAIL_HEADER_LOGO_ALT = os.getenv("EMAIL_HEADER_LOGO_ALT", "IERMS")
