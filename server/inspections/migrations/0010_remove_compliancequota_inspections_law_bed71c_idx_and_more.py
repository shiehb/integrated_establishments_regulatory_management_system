# Generated by Django 4.2.17 on 2025-11-05 17:45
# Updated to safely handle missing indexes
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inspections', '0009_add_month_field_to_quota'),
    ]

    operations = [
        # Safely remove old index if it exists
        migrations.RunPython(safe_remove_index, migrations.RunPython.noop),
        # Update quarter field help text (metadata only, no DB change)
        migrations.AlterField(
            model_name='compliancequota',
            name='quarter',
            field=models.IntegerField(choices=[(1, 'Q1'), (2, 'Q2'), (3, 'Q3'), (4, 'Q4')], help_text='Quarter 1-4 (derived from month)'),
        ),
