            ...
            <table className="min-w-full">
              <thead>
                <tr className="sticky top-0 z-10 bg-gradient-to-r from-sky-600 to-sky-700 text-left text-xs font-semibold uppercase tracking-wide text-white">
                  ...
                  <th className="px-4 py-3">NOV/NOO</th>
                  <th className="px-4 py-3">Compliance</th>
                  <th className="px-4 py-3">Legal Action</th>
                </tr>
              </thead>
                  ...
                  records.map((record) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-4 py-3 text-sm text-gray-700">
                        {record.has_nov && record.has_noo ? 'NOV, NOO' : 
                         record.has_nov ? 'NOV' :
                         record.has_noo ? 'NOO' : 'None'}
                      </td>
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <span
                          className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium border ${
                      ...
                      <td className="whitespace-nowrap px-4 py-3 text-sm text-gray-600">
                        {record.legal_action?.replace(/_/g, ' ') || 'None'}
                      </td>
                    </tr>
                  ))
                )}
