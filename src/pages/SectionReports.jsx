...
export default function SectionReports() {
  ...
  // Pagination
  const savedPagination = useLocalStoragePagination('section_reports');
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          dataResponse = await getSectionReportData(params);
  ...
  const handleExportPDF = async () => {
    ...
    try {
      await exportSectionReportPDF(filterParams);
  ...
  const handleExportExcel = async () => {
    ...
    try {
      await exportSectionReportExcel(filterParams);
  ...
  const pageContent = (
    <div className="space-y-4">
      ...
      <div>
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-[repeat(6,minmax(0,1fr))_auto]">
