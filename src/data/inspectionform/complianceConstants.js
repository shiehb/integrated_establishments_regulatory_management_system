...
export const initialComplianceItems = [
  ...
  { //HARRY START 
    ...
    complianceRequirement: "Biennial Report for those chemicals that are for issuance of CCO",
    compliant: "N/A",
    remarks: "",
    category: "Reporting",
    priority: "Medium",
  ...
  },
  {
    ...
    applicableLaw: "Waste Transporter, Waste Transport Record; Waste Treatment and Disposal Premises",
    complianceRequirement: "WCompliance with Manifest system (Waste Transport Record)",
    compliant: "N/A",
    remarks: "",
    category: "Operational",
    priority: "Medium",
  ...
  },
  {
    ...
    applicableLaw: "Permit to Operate (Air)",
    complianceRequirement: "POA is displayed in a conspicuous place near the installation",
    compliant: "N/A",
    remarks: "",
    category: "Documentation",
    priority: "Medium",
  ...
  },
  {
    ...
    applicableLaw: "Permit to Operate (Air)",
    complianceRequirement: "Plant operational problems lasting for more than 1 hour should be reoprted to EMB w/in 24 hrs.",
    compliant: "N/A",
    remarks: "",
    category: "Reporting",
    priority: "Medium",
  ...
  },
  {
    ...
    applicableLaw: "Permit to Operate (Air)",
    complianceRequirement: "CEMS/PEMS installed (for petroleum refineries, power/cement plants or sources emitting (750Tons/yr.) Yearly RATA/Quarterly CGA conducted (for sources w/CEMS",
    compliant: "N/A",
    remarks: "",
    category: "Monitoring",
    priority: "Medium",
  ...
  },
  {
    ...
    applicableLaw: "Discharge Permit (DP)",
    complianceRequirement: "Certificate of septage siphoning hauled by accredited service provider",
    compliant: "N/A",
    remarks: "",
    category: "Documentation",
    priority: "Medium",
  },
  {
    ...
    applicableLaw: "Effluent Testing Report (if applicable)",
  ...
  },
  {
    ...
    applicableLaw: "Waste Segregation",
    complianceRequirement: "Segregated solid waste collected by LGU or Private Contractor Name of PC:",
    compliant: "N/A",
    remarks: "",
    category: "Operational",
    priority: "Medium",
  ...
  },
  {
    ...
    conditionId: "PCO-1",
    applicableLaw: "DAO 2014-02 or Revised Guidelines on PCO Accreditation",
  ...
  },
  {
    ...
    conditionId: "SMR-2",
    applicableLaw: "DAO 2003-27",
    complianceRequirement: "Complete and timely submission of CMRs/CMVRs (semi-annualy)",
    compliant: "N/A",
    remarks: "",
    category: "Reporting",
    priority: "Medium",
