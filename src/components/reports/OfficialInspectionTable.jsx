      ...
      <table className="w-full min-w-[800px]">
        <thead>
          <tr className="text-xs text-left text-white bg-gradient-to-r from-sky-600 to-sky-700 sticky top-0 z-10">
            ...
            <th className="px-3 py-2 border-b text-center border-gray-300">Law</th>
            <th className="px-3 py-2 border-b text-center border-gray-300">Compliance</th>
            <th className="px-3 py-2 border-b text-center border-gray-300">Date</th>
          </tr>
        </thead>
        <tbody>
          {loading ? (
            <tr>
              <td colSpan={6} className="px-8 py-8 text-center border-b border-gray-300">
            ...
            <tr>
              <td colSpan={6} className="px-8 py-8 text-center text-gray-500 border-b border-gray-300">
